...
- **explore_events_button_clicked**: Fired when a user clicks the 'Explore Events' button to navigate to the events section of the page.

### components\Navbar.tsx

- **navbar_link_clicked**: Fired when a user clicks on a navigation link in the main navbar.
